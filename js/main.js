...
var shapes = [
    ...
    {
        wave1: {amplitude: 176.923, frequency: 0.879, phase: 0},
        wave2: {amplitude: 60, frequency: 0.165, phase: 0},
        wave3: {amplitude: 50, frequency: 0, phase: 0}
    },
    {
        wave1: {amplitude: 125, frequency: 0.5, phase: 0},
        wave2: {amplitude: 50, frequency: 10, phase: 0},
        wave3: {amplitude: 35, frequency: 10, phase: 0}
    },
    {
        wave1: {amplitude: 400, frequency: 15.692, phase: 6.283},
        wave2: {amplitude: 400, frequency: 15.912, phase: 6.283},
        wave3: {amplitude: 400, frequency: 10, phase: 6.283}
    },
    {
...
$(document).ready(function(){
    ...
    window.addEventListener('scroll', function (event) {
        if (isInViewport(intro)) {
            blob.morphTo(shapes[10]);
            blob.blobSize = 300;
            animateDistance(1000, 100);
